...
const PostCard: React.FC<PostCardProps> = ({ post }) => {
  const { caption, image ,likes } = post;
...
console.log(post);
  return (
    <div className="max-w-2xl mx-auto p-4 rounded-lg shadow space-y-4 mb-4 bg-[#2a3a4b]">
    {'user' in post &&  <div className="flex items-center space-x-4" onClick={()=>redirect(`/profile?id=${post.createdBy.toString()}`)}>
        <img  src={post.user.image} className='w-[50px] h-[50px] rounded-full' />
        <div>
      ...
      {image && (
        <div className="relative w-full flex justify-center">
          <div className="w-80 h-70 overflow-hidden rounded-lg">
            <img
              src={image}
              alt="Post Image"
