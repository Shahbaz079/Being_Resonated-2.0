...
import { login, signGithub, signGoogle } from "@/action/user";
...
const  Login=async ()=> {
  ...
  return (
    ...
    <div className="w-[40vw] mx-32 my-10 rounded-none md:rounded-2xl p-10 md:p-8 shadow-input bg-white dark:bg-black">
      ...
      <form className="my-8 text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300" action={login}>
