  ...
  return (
    <div className="background">
      <div className="sections">
        <div className="heading">Department of Metallurgy and Materials Science</div>
        <div>
          <button className="pyq" onClick={() => setIsOpen(!isOpen)}>
            󱄶 Previous Year Questions {isOpen ? "󰄿" : "󰄼"}
          </button>
          <div className={`sems ${isOpen ? "open" : ""}`}>
            <p><Link href="/resources/metallurgy/mt_midsem_pyq/">Mid-Semester</Link></p>
            <p><Link href="/resources/metallurgy/mt_endsem_pyq/">End-Semester</Link></p>
