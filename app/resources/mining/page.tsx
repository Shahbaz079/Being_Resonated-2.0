  ...
  return (
    <div className="background">
      <div className="sections">
        <div className="heading">Department of Mining Engineering</div>
        <div>
          <button className="pyq" onClick={() => setIsOpen(!isOpen)}>
            󱄶 Previous Year Questions {isOpen ? "󰄿" : "󰄼"}
          </button>
          <div className={`sems ${isOpen ? "open" : ""}`}>
            <p><Link href="/resources/mining/mn_midsem_pyq/">Mid-Semester</Link></p>
            <p><Link href="/resources/mining/mn_endsem_pyq/">End-Semester</Link></p>
