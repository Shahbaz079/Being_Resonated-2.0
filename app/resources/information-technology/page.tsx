  ...
  return (
    <div className="background">
      <div className="sections">
        <div className="heading">Department of Information Technology</div>
        <div>
          <button className="pyq" onClick={() => setIsOpen(!isOpen)}>
            󱄶 Previous Year Questions {isOpen ? "󰄿" : "󰄼"}
          </button>
          <div className={`sems ${isOpen ? "open" : ""}`}>
            <p><Link href="/resources/information-technology/it_midsem_pyq/">Mid-Semester</Link></p>
            <p><Link href="/resources/information-technology/it_endsem_pyq/">End-Semester</Link></p>
