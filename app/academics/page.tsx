    ...
    <div className="relative min-h-screen bg-gradient-to-r from-gray-900 via-gray-800 to-black dark:from-gray-900 dark:via-gray-800 dark:to-black">
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className={`text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-cyan-200 to-cyan-100 ${isHeadingVisible ? "animate-fade-in" : ""}`}>
            Academic Resources Hub
          </h1>
          <p className={`text-xl font-light text-transparent bg-clip-text bg-gradient-to-r from-cyan-200 via-cyan-100 to-cyan-50 mt-4 ${isHeadingVisible ? "animate-fade-in-delay" : ""}`}>
        ...
        <div className="flex flex-col space-y-6 items-center">
          {departments.map((dept, index) => (
            ...
            >
              <div className="bg-gray-800 border-4 border-cyan-600 rounded-full p-4 h-full flex flex-col shadow-lg hover:shadow-2xl cursor-pointer hover:bg-gray-700 transition-colors duration-300 dark:bg-gray-700 dark:border-cyan-500">
