  ...
  return (
    <div className='py-4 w-full'>
      <div className="w-[80vw] h-[2%] flex flex-row justify-around mx-[10vw]">
        ...
        <Link  href={`/becommunity?id=${userId}`} className="shadow-[inset_0_0_0_2px_#616467] text-gray-400 px-[5%] py-[2%] rounded-full tracking-widest  font-bold bg-transparent 
